...
public class BatteryLoggerService extends Service {
	...
	private void registerSensor() {
		try {
			Uri sensorUri = SensAppHelper.registerNumericalSensor(getApplicationContext(), sensorName, "Battery level", SensAppUnit.percent, getResources().getDrawable(R.drawable.ic_launcher));
			if (sensorUri == null) {
