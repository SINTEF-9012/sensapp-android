...
public class QueryGraphSensorsTask extends AsyncTask<Void, Void, Hashtable<Integer, ContentValues>> {

	private Context context;
	private String selection;

	public QueryGraphSensorsTask(Context context, String selection) {
